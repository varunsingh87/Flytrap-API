...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        break;
    case 'POST':
        SimpleRest::handlePostParameterValidation("recipient_email", "audio_id");
        $dbHandler->setAudioId($_POST["audio_id"]);
        $response = $dbHandler->shareAudio($_POST["recipient_email"]);
